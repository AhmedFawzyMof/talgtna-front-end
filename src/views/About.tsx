    ...
    <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      <div className="space-y-4">
        ...
        <details className="group [&_summary::-webkit-details-marker]:hidden">
          ...
          <p className="mt-4 px-4 leading-relaxed text-gray-700">
            يوفر "إيزي كوك فروزين" تشكيلة واسعة من المجمدات بمختلف الأنواع
            والنكهات، مما يتيح للعملاء اختيار ما يفضلونه وفقًا لذوقهم الشخصي.
          </p>
        </details>
        ...
        <details className="group [&_summary::-webkit-details-marker]:hidden">
          ...
          <p className="mt-4 px-4 leading-relaxed text-gray-700">
            تهتم "إيزي كوك فروزين" بتقديم المنتجات ذات الجودة العالية، حيث يتم
        ...
        <details className="group [&_summary::-webkit-details-marker]:hidden">
          ...
          <p className="mt-4 px-4 leading-relaxed text-gray-700">
            ييوفر "إيزي كوك فروزين" تشكيله كبيره وواسعه ومختلفه من المنتجات
            ويخدم هذا الاختلاف العميل بحيث يجد كل عميل ما يناسب ذوقه الشخصي
          </p>
        </details>
        ...
        <details className="group [&_summary::-webkit-details-marker]:hidden">
          ...
          <p className="mt-4 px-4 leading-relaxed text-gray-700">
            يوفر "إيزي كوك فروزين" خدمة توصيل سريعة وموثوقة، مما يوفر الوقت
            والجهد للعملاء ويتيح لهم الاستمتاع بالمجمدات في أي وقت.
          </p>
        </details>
      </div>
    </div>
